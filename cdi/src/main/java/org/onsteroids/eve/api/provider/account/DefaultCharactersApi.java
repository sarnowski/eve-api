 ...
 */
@Singleton
final class DefaultCharactersApi extends AbstractApiService implements CharactersApi {
	private static final Logger LOG = LoggerFactory.getLogger(DefaultCharactersApi.class);

	@Inject
	public DefaultCharactersApi(ApiConnection apiConnection, ApiCache apiCache) {
		super(apiConnection, apiCache);
	}

	@Override
	public Characters getCharacters(LimitedApiKey key) throws ApiException {
		return call(DefaultCharacters.class, CharactersApi.XMLPATH, key);
	}
}
