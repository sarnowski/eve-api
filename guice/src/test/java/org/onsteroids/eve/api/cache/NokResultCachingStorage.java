 ...
 */
public class NokResultCachingStorage extends AbstractApiTest {
    private static final Logger LOG = LoggerFactory.getLogger(NokResultCachingStorage.class);

    public NokResultCachingStorage() {
        super(true);
    }
